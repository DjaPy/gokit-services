...
import (
	...
	gkgrpc "github.com/DjaPy/gokit-services/grpc"
)
...
func TestGrpcClient_ConnAvailableAfterStart(t *testing.T) {
	...
	srv := gkgrpc.NewServer(gkgrpc.WithPort(0), gkgrpc.WithHost("127.0.0.1"))
	...
	c := gkgrpc.NewClient(srv.Addr(),
		gkgrpc.WithDialOptions(grpclib.WithTransportCredentials(insecure.NewCredentials())),
	)
